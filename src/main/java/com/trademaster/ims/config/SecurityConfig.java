...
public class SecurityConfig {
 ...
 @Bean public SecurityFilterChain filterChain(HttpSecurity http)throws Exception{
  http.cors(c->c.configurationSource(corsConfigurationSource())).csrf(c->c.disable()).sessionManagement(s->s.sessionCreationPolicy(SessionCreationPolicy.STATELESS)).exceptionHandling(e->e
   ...
   .requestMatchers(HttpMethod.GET,"/api/mobile/v1/health","/api/mobile/v1/categories","/api/mobile/v1/categories/*","/api/mobile/v1/categories/*/products","/api/mobile/v1/products","/api/mobile/v1/products/*","/api/mobile/v1/products/search","/api/mobile/v1/offers","/api/mobile/v1/offers/*","/api/mobile/v1/offers/*/products").permitAll()
   ...
   .requestMatchers(HttpMethod.POST,"/api/mobile/v1/auth/logout","/api/mobile/v1/auth/change-password","/api/mobile/v1/profile/photo").hasRole("CUSTOMER")
   ...
   .requestMatchers("/api/mobile/v1/addresses","/api/mobile/v1/addresses/**","/api/mobile/v1/checkout/**","/api/mobile/v1/orders","/api/mobile/v1/orders/**","/api/mobile/v1/notifications","/api/mobile/v1/notifications/**","/api/mobile/v1/payments/mobile-wallet/**").hasRole("CUSTOMER")
