...
import com.trademaster.ims.service.ExpenseCategoryService;
...
public class ExpenseCategoryController {
    ...
    public ResponseEntity<ExpenseCategory> updateCategory(@PathVariable Long id, @RequestBody ExpenseCategory category) {
        ExpenseCategory updated = categoryService.updateCategory(id, category);
    ...
    @PostMapping("/bulk")
    public ResponseEntity<List<ExpenseCategory>> createBulkCategories(@RequestBody List<ExpenseCategory> categories) {
        List<ExpenseCategory> created = categoryService.createBulkCategories(categories);
        return new ResponseEntity<>(created, HttpStatus.CREATED);
    }
}